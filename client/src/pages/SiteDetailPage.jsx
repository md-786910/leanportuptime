...
export default function SiteDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tab content */}
      {activeTab === 'overview' && <SiteOverviewTab site={site} summary={summary} checks={checks} period={period} />}
      ...
      {activeTab === 'history' && (
        <div className="space-y-6">
          <UptimeBar checks={checks} days={period === '24h' ? 1 : period === '7d' ? 7 : 30} />
      ...
      <EditSiteModal isOpen={showEdit} onClose={() => setShowEdit(false)} site={site} />
      <ConfirmDialog
        isOpen={showDelete}
