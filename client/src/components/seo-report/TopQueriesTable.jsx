  ...
  return (
    <span className="inline-flex items-center gap-1">
      ...
      <button
        ...
        className="inline-flex items-center text-gray-400 hover:text-amber-500 transition-colors"
      >
      ...
      {open && createPortal(
        <div
          ...
          onMouseLeave={() => setOpen(false)}
          className="w-52 p-2.5 rounded-lg bg-gray-900 text-white text-[11px] font-normal leading-relaxed shadow-xl"
        ...
        >
          ...
          <div className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-gray-400 inline-block flex-shrink-0"></span> 20+ — Low visibility</div>
        </div>,
        document.body
      )}
    </span>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-gray-50 dark:bg-gray-800/50">
              ...
              <th className="text-left py-2.5 px-3 font-medium text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider">Query</th>
              <th className="text-right py-2.5 px-3 font-medium text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider">Clicks</th>
              <th className="text-right py-2.5 px-3 font-medium text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider">Impressions</th>
              <th className="text-right py-2.5 px-3 font-medium text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider">CTR</th>
          ...
          <tbody>
            {queries.map((row, i) => (
              <tr key={i} className="border-t border-gray-50 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                ...
                <td className="py-2 px-3 text-gray-900 dark:text-gray-100 font-medium max-w-[200px] truncate">
                ...
                <td className="py-2 px-3 text-right tabular-nums">
                  <span className={row.position <= 10 ? 'text-emerald-600 dark:text-emerald-400 font-semibold' : row.position <= 20 ? 'text-amber-600 dark:text-amber-400' : 'text-gray-500 dark:text-gray-400'}>
